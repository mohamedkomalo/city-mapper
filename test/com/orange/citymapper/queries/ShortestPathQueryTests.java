...
public class ShortestPathQueryTests {
	...
	public void testGetSource(){
		...
		String sourceCity = shortestPathQuery.getSource("What is the shortest path between City Cairo to City Kenna?");
	...
	public void testGetDestination(){
		...
		String destinationCity = shortestPathQuery.getDestination("What is the shortest path between City Cairo to City Kenna?");
